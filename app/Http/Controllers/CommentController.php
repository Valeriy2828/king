...
class CommentController extends SiteController
{
    ...
    {
        $data = $request->except('_token','comment_post_ID','comment_parent');//какие поля не будут попадать в БД
        //print_r($data);
        ...
        //                           return !Auth::check();                                    });//валидация полей которые не всегда передаются
